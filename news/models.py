...
class Article(models.Model):
    ...
    created_date = models.DateTimeField(auto_now_add=True) #When this option is set, the field will be set to the current date and time when an object is created for the first time.
